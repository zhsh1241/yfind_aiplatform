...
export type PipelineRunDetail = { run: PipelineRunSummary; nodeRuns: PipelineRunNode[]; preview: PreprocessedDatasetPreview | null; activation: PreprocessedDatasetActivationState | null };
