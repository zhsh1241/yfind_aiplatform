...
- `diagnostic` 允许值：`PRESIGNED_URL_READY`、`AUTHENTICATED_CONTENT_ENDPOINT_READY`、`TODO_CONFIRM_*;AUTHENTICATED_CONTENT_ENDPOINT_READY`、`ARTIFACT_WITHOUT_FILE_OBJECT`。
...
| 422 | 42255 | 评估报告 artifact 文件对象不存在或不可用 | 评估 artifact 规则 |
