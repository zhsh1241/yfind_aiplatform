...
CREATE TABLE model_registry_version (
    ...
    CONSTRAINT uk_model_registry_version_model_identity UNIQUE (model_id, version_id),
...
CREATE TABLE model_access_request (
    ...
    CONSTRAINT fk_model_access_request_model_version FOREIGN KEY (model_id, version_id) REFERENCES model_registry_version(model_id, version_id),
...
CREATE TABLE model_access_grant (
    ...
    CONSTRAINT fk_model_access_grant_model_version FOREIGN KEY (model_id, version_id) REFERENCES model_registry_version(model_id, version_id),
...
INSERT INTO platform_role_permission (id, role_code, permission_code)
SELECT 'BU_ADMIN::menu:hub', 'BU_ADMIN', 'menu:hub'
WHERE NOT EXISTS (SELECT 1 FROM platform_role_permission WHERE id = 'BU_ADMIN::menu:hub');
INSERT INTO platform_role_permission (id, role_code, permission_code)
